            ...
            <div class="content">
                ...
                <table cellspacing="0" cellpadding="0" border="0" style="margin:20px auto">
                    <tr>
                        ...
                        <td style="border:1px solid #000;padding:20px;border-bottom:0;border-top-right-radius:5px;font-size:2rem;">{{ $stats->users->total }}</td>
                    </tr>
                    <tr>
                        <td style="border:1px solid #000;border-right:0;border-bottom:0;padding:20px;border-top-left-radius:5px;">Stylists:</td>
                        <td style="border:1px solid #000;padding:20px;border-bottom:0;border-top-right-radius:5px;font-size:2rem;">{{ $stats->stylists->total }}</td>
                    </tr>

                    <tr>
                        <td style="border:1px solid #000;border-right:0;padding:20px;border-bottom-left-radius:5px;">Posts:</td>
                        <td style="border:1px solid #000;padding:20px;border-bottom-right-radius:5px;font-size:2rem;">{{ $stats->posts->numPublished }}</td>
                    </tr>
