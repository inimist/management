...
@section('content')
    ...
    <p>
        <a href="{{ route('accounts.homefeed', ['id' => $account->id]) }}" class="btn btn-default">View Home Feed</a>
        <a href="{{ route('accounts.photo', ['id' => $account->id]) }}" class="btn btn-default">Update photo</a>
    </p>
    @if (isset($account->stats))
        ...
        <table class="table">
            ...
            @if (isset($account->created))
                <tr>
                    <th>Created</th>
                    <td>{{ date("Y-m-d", $account->created) }}</td>
                </tr>
            @endif
            @if (isset($account->providers) && $account->providers)
                <tr>
                    <th>Providers</th>
                    <td>{{ join(', ', $account->providers)  }}</td>
                </tr>
            @endif
            @if (isset($account->accountType) && $account->accountType)
                <tr>
                    <th>Account Type</th>
