<?php $__env->startSection('content'); ?>
	...
	<p><a href="<?php echo e(route('categories.show', ['id' => $category->id])); ?>">Back to Overview</a></p>

	<h1>Editing <?php echo e($category->name); ?></h1>
	
	<?php echo e(Form::model($category, array('action' => array('CategoriesController@update', $category->id), 'method' => 'PUT'))); ?>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="form-group">
				...
				<?php echo e(Form::checkbox('enable', null)); ?>
			...
			<div class="form-group">
				...
				<?php echo e(Form::select('parentId', $categories, null, ['class' => 'form-control'])); ?>
			...
			<div class="form-group">
				...
				<?php echo e(Form::textarea('aliases', $aliases, ['class' => 'form-control'])); ?>
